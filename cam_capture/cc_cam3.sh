...
# === OVERVIEW ===
# This script handles downloading and streaming footage from CAM3


# === CONFIGURATION ===
RTSP_SUB="rtsp://admin:Hovnokleslo123.@192.168.88.243:554/media/video2"   # Lower-res stream for live view
RTSP_MAIN="rtsp://admin:Hovnokleslo123.@192.168.88.243:554/media/video1"  # Full-res stream for recording

TMP_DIR="/tmp/cam3_gstream_chunks"             # Temporary location for FIFOs and buffers
